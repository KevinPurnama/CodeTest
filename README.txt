...
- All input data collected may eventually end up in a database, so proper data cleansing is required. The design also takes into consideration the data that might need to be changed in future.
